...
class WideDeepPipeline(BasePipeline):
    def __init__(self, model_path: str, model_training=False, **kwargs):
        super(WideDeepPipeline, self).__init__(model_path=model_path, model_training=model_training, **kwargs)
    ...
    def train(self, X, y, train_params):
        ...
        self.model = WDL(linear_feature_columns, dnn_feature_columns, task='binary')
        self.model.summary()
